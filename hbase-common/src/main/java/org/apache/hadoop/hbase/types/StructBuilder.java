...
public class StructBuilder {
  ...
  /**
   * Create an empty <code>StructBuilder</code>.
   */
  public StructBuilder() {}

  /**
   * Append <code>field</code> to the sequence of accumulated fields.
   */
  public StructBuilder add(DataType<?> field) { fields.add(field); return this; }

  /**
   * Retrieve the {@link Struct} represented by <code>this</code>.
   */
