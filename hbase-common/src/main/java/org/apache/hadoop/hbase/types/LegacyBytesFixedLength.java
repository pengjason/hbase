...
public class LegacyBytesFixedLength extends FixedLengthWrapper<byte[]> {

  /**
   * Create a <code>LegacyBytesFixedLength</code> using the specified
   * <code>order</code> and <code>length</code>.
   */
  public LegacyBytesFixedLength(Order order, int length) {
    super(new LegacyBytes(order), length);
  }

  /**
   * Create a <code>LegacyBytesFixedLength</code> of the specified
   * <code>length>.
   */
  public LegacyBytesFixedLength(int length) {
    super(new LegacyBytes(), length);
  }
