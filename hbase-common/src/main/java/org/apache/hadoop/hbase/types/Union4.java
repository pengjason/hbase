...
public abstract class Union4<A, B, C, D> extends Union3<A, B, C> {
  ...
  /**
   * Create an instance of <code>Union4</code> over the set of specified
   * types.
   */
  ...
  /**
   * Read an instance of the fourth type parameter from buffer <code>b</code>.
   */
  public D decodeD(ByteBuffer b) {
    return (D) decode(b);
  }
}
