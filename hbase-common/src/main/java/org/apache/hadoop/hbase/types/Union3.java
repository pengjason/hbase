...
public abstract class Union3<A, B, C> extends Union2<A, B> {
  ...
  /**
   * Create an instance of <code>Union3</code> over the set of specified
   * types.
   */
  ...
  /**
   * Read an instance of the third type parameter from buffer <code>b</code>.
   */
  public C decodeC(ByteBuffer buff) {
