...
/**
 * The <code>Union</code> family of {@link DataType}s encode one of a fixed
 * set of <code>Object</code>s. They provide convenience methods which handle
...
public abstract class Union2<A, B> implements DataType<Object> {
  ...
  /**
   * Create an instance of <code>Union2</code> over the set of specified
   * types.
   */
   ...
   * <code>buff</code>.
   */
  public A decodeA(ByteBuffer buff) {
    return (A) decode(buff);
  }
   ...
   * <code>buff</code>.
   */
  public B decodeB(ByteBuffer buff) {
    return (B) decode(buff);
  }
}
